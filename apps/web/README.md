...
Vitest + Testing Library: HTTP-клиент, идемпотентность, сессия, поллинг оплаты, правила checkout и экраны каталога, корзины, оформления, оплаты и заказа. Тесты лежат в `apps/web/src/test/`.

Подробности решения (состояние, HTTP-клиент, сценарии, недоработки, время) — в разделе «Решение» корневого [README.md](../../README.md).
